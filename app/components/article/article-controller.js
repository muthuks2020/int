...
unipaper.controller('articleController', function($scope, contentful, environmentVariables, $rootScope, $stateParams, utilityFactory, $state, $window, $http) {
  ...
  var fillArticleContent = function(articleRaw) {
    $scope.article = {
      ...
      seoDescription: articleRaw.fields !== undefined && articleRaw.fields.seoDescription !== undefined && articleRaw.fields.seoDescription !== '' ? articleRaw.fields.seoDescription : '',
...
description: $scope.article.seoDescription
    };
